...
namespace PushSharp.Apple
{
    public class AppleNotificationPayload
    {
        ...
        /// <summary>
        /// Custom JSON that is appended to the message
        /// </summary>
        public JObject CustomJson { get; set; }
        ...
        public void AddCustom(string rawJson)
        {
            CustomJson = (JObject)Newtonsoft.Json.JsonConvert.DeserializeObject(rawJson);
        }
        ...
        public string ToJson()
        {
            ...
            if (CustomJson != null)
            {
                foreach (KeyValuePair<string, JToken> kv in CustomJson)
                {
